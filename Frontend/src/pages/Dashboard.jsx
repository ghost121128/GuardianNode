...
return (
  <div className={`min-h-screen p-8 ${
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
      {/* Total Threats */}
      <div className="bg-[#0B1120] border border-cyan-500/20 rounded-3xl p-6 shadow-xl">
      ...
      {/* Critical Alerts */}
      <div className="bg-[#0B1120] border border-red-500/20 rounded-3xl p-6 shadow-xl">
        <div className="flex justify-between items-center mb-4">
          <p className="text-gray-400">
            Critical Alerts
          </p>
      ...
      {/* Blocked */}
      <div className="bg-[#0B1120] border border-orange-500/20 rounded-3xl p-6 shadow-xl">
        <div className="flex justify-between items-center mb-4">
          <p className="text-gray-400">
            Blocked Attacks
          </p>
      ...
      {/* Monitoring */}
      <div className="bg-[#0B1120] border border-green-500/20 rounded-3xl p-6 shadow-xl">
        <div className="flex justify-between items-center mb-4">
          <p className="text-gray-400">
            Monitoring
          </p>
    ...
    {/* Globe Section */}
    <div className="mt-10">
      <div className="bg-[#0B1120] border border-cyan-500/10 rounded-[32px] overflow-hidden shadow-2xl">
        {/* Header */}
        ...
        <iframe
          ...
          className="w-full h-[700px] border-0 mt-6"
        />
      </div>
    </div>
  </div>
